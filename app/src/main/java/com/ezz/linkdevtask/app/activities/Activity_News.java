...
public class Activity_News extends BaseActivity implements NewSelectedListener {
    ...
    public void Init_UI() {
        ...
        txtusername.setText(Utilities.getStringFromSharedPref(Constants.nameprefkey, Activity_News.this));
        txtusermail.setText(Utilities.getStringFromSharedPref(Constants.emailprefkey, Activity_News.this));
    ...
    View.OnClickListener btnlogoutonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (currentsocial == SocialMediaDetector.facebook) {
                LoginManager.getInstance().logOut();
            } else if (currentsocial == SocialMediaDetector.twitter) {
                Twitter.getInstance();
                Twitter.logOut();
            } else if (currentsocial == SocialMediaDetector.google) {
                Auth.GoogleSignInApi.signOut(googleApiClient);
            }
            startActivity(new Intent(Activity_News.this, Activity_Login.class));
            finish();
            Utilities.removeuserdatafromsharedpref(Activity_News.this);
        }
    };
